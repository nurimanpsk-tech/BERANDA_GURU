...
export default function PPMWeekSelector({ currentPpm, onSelect, user }: PPMWeekSelectorProps) {
  ...
  if (allPpms.length === 0) return null;
    ...
    <div className="relative group">
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none bg-white border border-stone-200 rounded-xl px-4 py-2.5 pr-10 text-sm font-medium text-stone-700 focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all cursor-pointer shadow-sm"
        >
