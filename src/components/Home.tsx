...
import { Sparkles, BookOpen, CheckSquare, Palette, Image, ArrowRight, ClipboardCheck, ArrowLeft, GraduationCap, Users, Settings, Wallet, UserCheck, UserCog, UserCircle, Mail, Inbox, Send, Contact, Megaphone, Database } from 'lucide-react';
...
export default function Home({ 
  ...
  const mainMenuItems = [
    ...
    },
    {
      id: 'pengaturan',
      title: 'Pengaturan',
      description: 'Atur profil sekolah, data guru, dan preferensi aplikasi.',
  ...
  return (
    <div className="min-h-screen bg-[#F5F2ED] text-[#1A1A1A] font-sans p-4 md:p-8 flex flex-col justify-center items-center">
      <div className="max-w-6xl w-full">
        {!showAsesmenMenu && !showAbsensiMenu && !showSuratMenu && (
